  ...
  return (
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="font-serif bg-white p-8 rounded-lg">
        ...
        <h3 className="text-indigo-500 font-bold text-4xl text-center">Código de <span className='text-secFormColor'>Sorteo</span></h3>
        ...
        <div className='flex items-center justify-center mt-2'>
            <FontAwesomeIcon icon={faTicket} className="text-yellow-400 w-24 h-24 mr-4" />
            <p className='text-3xl font-bold '>{code}</p>
        </div>
        
        <p className='max-w-lg'>
            Guarda tu código con el que podrás participar en el sorteo del carro que se realizará en las proximas semanas.
        </p>

        <p className='font-bold text-center mt-6'>No olvides seguirnos en nuestras redes sociales!</p>
        ...
        <div className="flex justify-between space-x-3 mt-3">
            ...
            <p className='font-sans flex items-end justify-start -mb-6 text-sm'>Codigo generado: {formattedDate} / {currentDateTime.toLocaleTimeString()}</p>
